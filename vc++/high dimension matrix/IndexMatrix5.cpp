...
int main(){
	...
	int a1[outdimen]={1,5,9,13},a2[outdimen]={2,6,10,14},a3[outdimen]={3,7,11,15},a4[outdimen]={4,8,12,16};
	Index index;
	dimension = 16;
	for(int i=0;i<outdimen;++i){
		for(int j=0;j<outdimen;++j){
			for(int k=0;k<outdimen;++k){
				for(int l=0;l<outdimen;++l){
					index.w=a1[i];
					index.x=a2[j];
					index.y=a3[k];
					index.z=a4[l];
